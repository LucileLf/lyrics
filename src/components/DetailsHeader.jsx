...
const DetailsHeader = ({ artistId, artistData, songData }) => { // used for both artist details and song details
  // console.log("songData", songData.resources['shazam-songs']['594265720'].attributes.images.coverArt);
  ...
  return (
    <div className="relative w-full flex flex-col">
      ...
      <div className="absolute inest-0 flex items-center">
        <img src={artistId ? artist?.artwork?.url.replace('{w}', '500').replace('{h}', '500') : coverArt} alt="art" className="sm:w-48 w-28 sm:h-48 h-28 rounded-full object-cover border-2 shadow-xl shadow-black" />
        <div className="ml-5">
